...
const remove = integers.filter(integer => integer < 19);
console.log(remove); 

// 3. Multiply each remaining number by 1.5 and then subtract 1.

const multiply = remove.map(number => (number * 1.5) - 1)
console.log(multiply);

// 4. Then output (either in the DOM or the console) the sum of all the resulting numbers.

const sum = multiply.reduce((total, currentNumber) => total + currentNumber, 0);
console.log(sum);